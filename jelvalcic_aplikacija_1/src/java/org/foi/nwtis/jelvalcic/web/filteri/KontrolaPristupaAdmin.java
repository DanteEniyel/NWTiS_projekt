 ...
 *
 * @author jelvalcic
 * Klasa filtera za kontrolu pristupa administratora
 */
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(request instanceof HttpServletRequest){
                ...
                Object vrsta = sesija.getAttribute("admin");
                //provjerava se postoji li korisnik u sesiji i da li je administrator
                if(korisnik == null || !(korisnik instanceof Korisnik) || vrsta == null){
                    //ukoliko ne postoji korisnik u sesiji ili nije administrator
                    //preusmjerava se na obrazac za prijavu
